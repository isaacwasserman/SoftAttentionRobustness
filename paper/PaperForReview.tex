...
\section{Related Work}
  ...
  \section{Results}
    ...
    \subsection{InceptionResNetV2 Models}
      ...
      In the pneumothorax detection task, the model with attention performed significantly worse under adversarial scenarios. The model reached an unusable accuracy after the perturbation radius was pushed beyond 0.00125, while the baseline remained usable with a perturbation radius of 0.005.
