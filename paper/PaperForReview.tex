...
\section{Related Work}
  ...
  \section{Method}
    ...
    \subsection{Preprocessing}
      ...
      \begin{figure}[h!]
        ...
        $
        \begin{array}{l}
        \includegraphics[width=0.4\linewidth]{graphics/unprocessedxray.png}
        \end{array}
        \mathlarger{\mathlarger{\mathlarger{\mathlarger{\rightarrow}}}}
        \begin{array}{l}
          \includegraphics[width=0.4\linewidth]{graphics/processedxray.jpg}
        \end{array}
        $
    ...
    \subsection{ResNet-50 Models}
      ...
      \begin{figure}[h!]
        \begin{subfigure}{\linewidth}
          ...
          $
          \begin{array}{l}
          \includegraphics[width=0.26\linewidth]{graphics/derm_unperturbed.jpg}
          \end{array}
          \mathlarger{\mathlarger{\mathlarger{\mathlarger{+}}}}
          \begin{array}{l}
            \includegraphics[width=0.26\linewidth]{graphics/derm_e=0.01_difference.jpg}
          \end{array}
          \mathlarger{\mathlarger{\mathlarger{\mathlarger{=}}}}
          \begin{array}{l}
            \includegraphics[width=0.26\linewidth]{graphics/derm_e=0.01.jpg}
          \end{array}
          $
        ...
        \begin{subfigure}{\linewidth}
          ...
          $
          \begin{array}{l}
          \includegraphics[width=0.26\linewidth]{graphics/dr_unperturbed.jpg}
          \end{array}
          \mathlarger{\mathlarger{\mathlarger{\mathlarger{+}}}}
          \begin{array}{l}
            \includegraphics[width=0.26\linewidth]{graphics/dr_e=0.32_difference.jpg}
          \end{array}
          \mathlarger{\mathlarger{\mathlarger{\mathlarger{=}}}}
          \begin{array}{l}
            \includegraphics[width=0.26\linewidth]{graphics/dr_e=0.32.jpg}
          \end{array}
          $
        ...
        \begin{subfigure}{\linewidth}
          ...
          $
          \begin{array}{l}
          \includegraphics[width=0.26\linewidth]{graphics/pneumo_unperturbed.jpg}
          \end{array}
          \mathlarger{\mathlarger{\mathlarger{\mathlarger{+}}}}
          \begin{array}{l}
            \includegraphics[width=0.26\linewidth]{graphics/pneumo_e=0.32_difference.jpg}
          \end{array}
          \mathlarger{\mathlarger{\mathlarger{\mathlarger{=}}}}
          \begin{array}{l}
            \includegraphics[width=0.26\linewidth]{graphics/pneumo_e=0.32.jpg}
          \end{array}
          $
  ...
  \section{Discussion}
    \subsection{Analysis of Attention Maps}
    \subsection{Effects of Attention} % What happened? Did it work?
